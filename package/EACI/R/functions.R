...
################################################################################
#' @title internal function - load library
...
#' @title internal function - load platform library
...
#' @title internal function - get environment information
...
#' @title internal function - sigma.fun
...
#' @title internal function - local.max
